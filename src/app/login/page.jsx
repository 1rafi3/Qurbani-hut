    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border border-amber-100 relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-amber-700/80">Sign in to your Qurbani Market account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 px-4 rounded-xl transition-colors shadow-md hover:shadow-lg"
          >
            Sign In
          </button>
        </form>
        ...
        <p className="mt-8 text-center text-sm text-amber-800">
          ...
          <Link href="/register" className="font-bold text-amber-600 hover:text-amber-800 hover:underline">
            Register here
          </Link>
        </p>
      </div>
